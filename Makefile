...
CFLAGS=-w -std=c++17 -g3 -ggdb -O0 -fno-strict-aliasing -fno-omit-frame-pointer -I/usr/local/include -L/usr/local/lib -D_GLIBCXX_USE_CXX11_ABI=0 -L/usr/lib/x86_64-linux-gnu -lnanomsg#-fsanitize=address
